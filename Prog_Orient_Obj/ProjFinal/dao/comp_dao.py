...
class Compra:
    def __init__(self, id_comp=None, data_comp="", cod_nf_comp="", total_comp="", cod_cli=None, cod_vers=None, cli=None, vers=None, uf=None):
...
class CompraDao:
    ...
    def select_comp_cli_az(self, cod_cli):
        ...
        sql="SELECT * FROM compra WHERE cod_cli=%s ORDER BY data_comp"
        try:
    ...
    def select_comp_vers_az(self, cod_vers):
        ...
        sql="SELECT * FROM compra WHERE cod_vers=%s ORDER BY data_comp"
        try:
