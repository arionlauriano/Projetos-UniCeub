...
class Versao:
    ...
    def __str__(self):
        return f"ID Versão: {self.id_vers} || Nome Versão: {self.nome_vers} || Valor Versão: R${self.vlr_vers} || Endereço Img: {self.img_vers} || Código Modelo: {self.cod_mod} || Nome Modelo: {self.mod.nome_mod}"
...
class VersaoDao:
    ...
    def add_vers(self, vers):
        ...
        # Ajuste para passar None, que será interpretado como NULL no MySQL
        if not valores[2]:
            valores[2] = None
        ...
        try:
            ...
            print(f"Erro ao adicionar versão: {err}")
            return f"Erro: {err}"
    ...
    def select_vers_az(self):
        ...
        try:
            ...
            lst_vers = None
            print(f"Erro ao buscar versões: {err}")
            return f"Erro: {err}"
        return lst_vers
    ...
    def select_vers_mod_az(self, cod_mod):
        ...
        try:
            ...
            lst_vers = None
            print(f"Erro ao buscar versões por modelo: {err}")
            return f"Erro: {err}"
        return lst_vers
    ...
    def select_vers_id(self, id_vers):
        ...
        try:
            ...
            print(f"Erro ao buscar versão por ID: {err}")
            return f"Erro: {err}"
